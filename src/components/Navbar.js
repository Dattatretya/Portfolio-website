    ...
    <Nav>
        <div className={openMenu ? 'menuIcon active' : 'menuIcon'}>
            <ul className='navbar-list'>
                ...
                <li>
                    <NavLink className="navbar-link" onClick={()=>setOpenMenu(false)} to='/links'>Links</NavLink>
                </li>
                <li>
                    <NavLink className="navbar-link" onClick={()=>setOpenMenu(false)} to='/contact'>Contact</NavLink>
                </li>
                <li>
                    <NavLink className="navbar-link" onClick={()=>setOpenMenu(false)} to='/Resume'>Resume</NavLink>
                </li>
            ...
            <div className='mobile-navbar-btn'>
                ...
                />
                <CgClose name='close-outline' className='close-outline mobile-nav-icon'
